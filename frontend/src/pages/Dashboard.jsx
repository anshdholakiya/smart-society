...
import FinancialChart from '../components/FinancialChart'; // <--- New
import SocietyShowcase from '../components/SocietyShowcase'; // <--- New
import EventBooking from '../components/EventBooking'; // <--- New
...
const Dashboard = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      // Merge retrieved API fields (including profile picture) over default token properties
...
>>>>>>>> 44dd50bcce535c099e7765d53c424180752a6e33:frontend/src/Dashboard.jsx
